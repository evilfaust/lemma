const FEATURES = [
  ...
  },
  {
    ...
    iconClass: 'landing-feature-icon--blue',
    title: 'Пиксель-арт',
    desc: 'Загрузи изображение — получи пиксельную сетку. Ученик закрашивает клетки по числам-ответам и проявляет рисунок. Нестандартный формат для любого класса.',
    tags: ['Печать A4', 'Сохранение', 'Ключ учителя'],
  },
]
