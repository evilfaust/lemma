const FEATURES = [
  {
    ...
    title: 'База задач',
    desc: '1000+ задач по всем темам ЕГЭ с LaTeX-формулами, изображениями, сложностью и тегами. Мощные фильтры и поиск.',
  ...
  },
  {
    ...
    title: 'Тестирование',
    desc: 'QR-код на экране — ученики сканируют и начинают тест. Автоматическая проверка, результаты в реальном времени.',
        ...
        <div className="landing-feature-card landing-feature-card--wide">
          <div>
            ...
            <p className="landing-feature-desc">
              30 уникальных ачивок трёх уровней редкости. Ученики стремятся собрать
              всю коллекцию — учёба становится приключением. Геймификация, которая работает.
            </p>
          </div>
